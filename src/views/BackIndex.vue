    ...
    <div class="rightDiv col-md-10">
      <div class="navDiv col-md-12">
        <nav class="navbar col-md-12 col-xs-12" role="navigation">
          <ul class="nav navbar-nav col-md-12">
            <li>
              <a @click="ShowVue()">列表</a>
            </li>
            <li>
              <a @click="ShowAdd()">新增</a>
            </li>
            <li>
              <a @click="ShowEdit()">修改</a>
            </li>
          </ul>
        </nav>
      </div>
      <div class="ShowDiv col-md-12" v-show="list">展示列表</div>
      <div class="AddDiv col-md-12" v-show="add">
        ...
        <div class="btn-group" role="group">
          <button type="button" class="btn btn-default" @click="DataSend()">确定</button>
        </div>
      </div>
      <div class="EditDiv col-md-12" v-show="edit">修改</div>
    </div>
  </div>
</template>
<script>
